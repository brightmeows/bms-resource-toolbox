...
## [0.1.0](https://github.com/brightmeows/bms-resource-toolbox/releases/tag/bms_res_tb_domain-v0.1.0) - 2026-09-16

### Other

- *(domain)* extract parallel helpers, reduce 5 iterators to ~30 lines each
